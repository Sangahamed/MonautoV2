...
class AdminSettings extends Component
{
    ...
    public function updateGeneralSettings(){
        ...
        if( $update ){
            $this->showToastr('success','Les paramètres généraux ont été mis à jour avec succès.');
        }else{
    ...
    public function updateSocialNetworks(){
        ...
        if( $update ){
            $this->showToastr('success','Les réseaux sociaux ont été mis à jour avec succès.');
        }else{
            $this->showToastr('error','Une erreur s\'est produite. Veuillez réessayer.');
        }
    }
