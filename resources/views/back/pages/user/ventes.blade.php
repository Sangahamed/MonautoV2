...
<div class="page-header">
    <div class="row">
        ...
        <div class="col-md-6 col-sm-12 text-right">
            <a href="{{ route('user.vendre.add-vehicule') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> Ajouter Vehicule</a>
        </div>
    </div>
</div>

@livewire('user.ventes')
...
@push('scripts')
    <script>
        $(document).on('click', 'a#deleteVendreBtn', function(e) {
            e.preventDefault();
            var url = "{{ route('user.vendre.delete-vendre') }}";
