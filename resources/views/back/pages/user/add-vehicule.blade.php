                ...
                <div class="row">
					...
					<div class="pd-20 card-box mb-30">
						...
						<div class="wizard-content">
                             <form class="tab-wizard wizard-circle wizard vertical"  id="steps-uid-1" action="{{ route('user.vendre.create-vendre') }}" method="POST" enctype="multipart/form-data">
								@csrf
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input name="kilometrage" type="text" class="form-control" />
											</div>
											@error('kilometrage')
												<span class="text-danger">{{ $message }}</span>
											@enderror
									...
									<div class="row">
                                        ...
                                        <div class="col-md-6">
											<div class="form-group">
												...
												<input name="couleurint" type="text" class="form-control" />
											</div>
											@error('couleurint')
												<span class="text-danger">{{ $message }}</span>
											@enderror
                                        ...
                                        <div class="col-md-6">
											<div class="form-group">
												...
												<input name="couleurext" type="text" class="form-control" />
											</div>
											@error('couleurext')
												<span class="text-danger">{{ $message }}</span>
											@enderror
											...
											<div class="form-group">
												...
												<select name="etatvehicule"  class="custom-select form-control">
													  <option value="" selected>Veuillez Selectionner</option>
                                                        ...
                                                        <option value="Neuf /Concessionaire">Neuf /Concessionaire</option>
                                                        <option value="Neuf /Importe">Neuf /Importe</option>
                                                        <option value="Occasion /Importe">Occasion /Importe</option>
                                                        <option value="Neuf /Parfait etat">Neuf /Parfait etat</option>
                                                        <option value="Neuf /Bon etat">Neuf /Bon etat</option>
                                                        <option value="Neuf /Passable">Neuf /Passable</option>
                                                        <option value="Occasion /Parfait etat">Occasion /Parfait etat</option>
                                                        <option value="Occasion /Bon etat">Occasion /Bon etat</option>
                                                        <option value="Occasion /Assez Bon">Occasion /Assez Bon</option>
									...
									<label class="weight-600"><h2>equipements</h2></label>
                                        <div class="row">
                                            <div class="col-md-3 col-sm-6 mb-3">
                                                ...
                                                <input name="equipements[]" value="ABS" type="checkbox" id="equipements1">
                                            ...
                                            <div class="col-md-3 col-sm-6 mb-3">
                                                <div class="checkbox-container">
                                                <input name="equipements[]" value="Radio" type="checkbox" id="equipements2">
                                                <label for="equipements2">Radio</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-3">
                                                <div class="checkbox-container">
                                                <input name="equipements[]" value="Air Bag" type="checkbox" id="equipements3">
                                                <label for="equipements3">Air Bag</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-3">
                                                <div class="checkbox-container">
                                                <input name="equipements[]" value="Camera arriere" type="checkbox" id="equipements4">
                                                <label for="equipements4">Camera de recul</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-3">
                                                <div class="checkbox-container">
                                                <input name="equipements[]" value="Climatisation" type="checkbox" id="equipements5">
                                                <label for="equipements5">Climatisation</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-3">
                                                <div class="checkbox-container">
                                                <input name="equipements[]" value="Direction Assistee" type="checkbox" id="equipements6">
                                                <label for="equipements6">Direction Assistee</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-3">
                                                <div class="checkbox-container">
                                                <input name="equipements[]" value="Decapotable" type="checkbox" id="equipements7">
                                                <label for="equipements7">Decapotable</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-3">
                                                <div class="checkbox-container">
                                                <input name="equipements[]" value="Toit Ouvrant" type="checkbox" id="equipements8">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-sm-6 mb-3">
                                                <div class="checkbox-container">
                                                <input name="accesoires[]" value="Android Auto" type="checkbox" id="accessoire1">
                                                <label for="accessoire1">Android Auto</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-3"> 
                                                <div class="checkbox-container">
                                                <input name="accesoires[]" value="Apple Play" type="checkbox" id="accessoire2">
                                                <label for="accessoire2">Apple Play</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-3">
                                                <div class="checkbox-container">
                                                <input name="accesoires[]" value="Feux antibrouillard" type="checkbox" id="accessoire3">
                                                <label for="accessoire3">Feux antibrouillard</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-3">
                                                <div class="checkbox-container">
                                                <input name="accesoires[]" value="Chargeur USB" type="checkbox" id="accessoire4">
                                                <label for="accessoire4">Chargeur USB</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-3">
                                                <div class="checkbox-container">
                                                <input name="accesoires[]" value="GPS" type="checkbox" id="accessoire5">
                                                <label for="accessoire5">GPS</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-3">
                                                <div class="checkbox-container">
                                                <input name="accesoires[]" value="Coffre de Toit" type="checkbox" id="accessoire6">
                                                <label for="accessoire6">Coffre de Toit</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-3">
                                                <div class="checkbox-container">
                                                <input name="accesoires[]" value="Bluetooth" type="checkbox" id="accessoire7">
                                                <label for="accessoire7">Bluetooth</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-3">
                                                <div class="checkbox-container">
                                                <input name="accesoires[]" value="Vitre electrique" type="checkbox" id="accessoire8">
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<textarea  id="description" name="description" class="form-control summernote" cols="30" rows="10"></textarea>
											</div>
											@error('description')
												<span class="text-danger">{{ $message }}</span>
											   @enderror
