...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Changer mot de passe')
@section('content')

<div class="login-box bg-white box-shadow border-radius-10">
    <div class="login-title">
        <h2 class="text-center text-primary">Changer mot de passe</h2>
    </div>
    <h6 class="mb-20">Entrer votre nouveau mot de passe ,Confirmer & Valider</h6>
    <form action="{{ route('user.reset-password-handler') }}" method="POST">
        @csrf
        <x-alert.form-alert/>
