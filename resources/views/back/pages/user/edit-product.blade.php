...
<div class="page-header">
    <div class="row">
        ...
        <div class="col-md-6 col-sm-12 text-right">
            <a href="{{ route('user.product.all-products') }}" class="btn btn-primary">View all products</a>
        </div>
    </div>
</div>

<form action="{{ route('user.product.update-product') }}" method="POST" enctype="multipart/form-data" id="updateProductForm">
    @csrf
...
<div class="row">
    <div class="col-12">
        <div class="card-box min-height-200px pd-20 mb-20">
            ...
            <form action="{{ route('user.product.upload-images',['product_id'=>request('id')]) }}" class="dropzone">
             @csrf
            </form>
...
<script src="/extra-assets/dropzonejs/min/dropzone.min.js"></script>
    <script>
       ...
       function getProductImages(){
            var url = "{{ route('user.product.get-product-images',['product_id'=>request('id')]) }}";
        ...
        $(document).on('change','select#category', function(e){
            ...
            var url = "{{ route('user.product.get-product-category') }}";
            if( category_id == '' ){
