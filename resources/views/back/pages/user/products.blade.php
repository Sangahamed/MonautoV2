...
<div class="page-header">
    <div class="row">
        ...
        <div class="col-md-6 col-sm-12 text-right">
            <a href="{{ route('user.product.add-product') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> Add new product</a>
        </div>
    </div>
</div>
...
@push('scripts')
    <script>
        $(document).on('click','a#deleteProductBtn', function(e){
             e.preventDefault();
             var url = "{{ route('user.product.delete-product') }}";
