                ...
                <div class="row">
					...
					<div class="pd-20 card-box mb-30">
						...
						<div class="wizard-content">
                             <form class="tab-wizard wizard-circle wizard vertical"  id="steps-uid-1" action="{{ route('user.location.create-location') }}" method="POST" enctype="multipart/form-data">
								@csrf
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" name="date_assurance_debut" class="form-control date-picker" placeholder="Select Date">
											</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" name="date_assurance_fin" class="form-control date-picker" placeholder="Select Date">
											</div>
											@error('date_assurance_debut')
												<span class="text-danger">{{ $message }}</span>
											@enderror
                                        ...
                                        <div class="col-md-6">
											<div class="form-group">
												...
												<input  type="text" name="annee_circulation" class="form-control date-picker" placeholder="Select Date">
											</div>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
                                                ...
                                                <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected"><input id="demo5" type="text" class="form-control" name="dernier_prix" value="5 000 000"><span class="input-group-addon bootstrap-touchspin-postfix input-group-append"><span class="input-group-text">Francs CFA</span></span><span class="input-group-btn input-group-append"></span></div>
									...
									<div class="row">
										<div class="col-md-6">
											...
											<div class="mb-2 mt-1" style="max-width: 200px">
										     <img src="" class="img-thumbnail" id="image-preview" data-ijabo-default-img="/images/Locations/carte_assurance/">
										    </div>
    ...
    <script>
       ...
       $(document).on('change', 'select#category', function(e) {
        ...
        $(document).on('click','#deleteProductImageBtn', function(e){
            e.preventDefault();
            var url = "{{ route('user.product.delete-product-image') }}";
        ...
        $('input[type="file"][name="image_assurance"]').ijaboViewer({
