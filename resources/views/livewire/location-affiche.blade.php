                ...
                @forelse ($locations as $item)
                    <div class="group rounded-xl bg-white dark:bg-slate-900 shadow hover:shadow-xl dark:hover:shadow-xl dark:shadow-gray-700 dark:hover:shadow-gray-700 overflow-hidden ease-in-out duration-500">
                        <div class="relative">
                           ...
                           @if ($firstImage)
                            <a href="{{ route('detail-location', ['idLocation' => $item->idLocation]) }}">
                        ...
                        <div class="p-6">
                            <div class="pb-6">
                                <a href="{{ route('detail-location', ['idLocation' => $item->idLocation]) }}" class="text-lg hover:text-green-600 font-medium ease-in-out duration-500">{{ $item->modele }} {{ $item->category }} {{ $item->annee }}</a>
                            </div>
                            ...
                            <ul class="pt-6 flex justify-between items-center list-none">
                                <li>
                                    ...
                                    <p class="text-lg font-medium">{{ $item->prix }} FCFA/JOUR</p>
                                </li>
